...
class FormularioCaixa(FlaskForm):
    ...
    dinheiro_total = DecimalField('Dinheiro Total', places=2, render_kw={'readyonly': True})
    ...
    cartao_deb_total = DecimalField('Cartão de Débito Total', places=2)
    ...
    pix_total = DecimalField('PIX Total', places=2)
    ...
    cheque_total = DecimalField('Cheque Total', places=2)
    total1 = DecimalField('Total 1', places=2)
    total2 = DecimalField('Total 2', places=2)
    total3 = DecimalField('Total 3', places=2)
    total4 = DecimalField('Total 4', places=2)
    total_total = DecimalField('Total Total', places=2)
    ...
    malote_total = DecimalField('Malote Total', places=2)
    ...
    sangria_total = DecimalField('Sangria Total', places=2)
    resultado1 = DecimalField('Resultado 1', places=2)
    resultado2 = DecimalField('Resultado 2', places=2)
    resultado3 = DecimalField('Resultado 3', places=2)
    resultado4 = DecimalField('Resultado 4', places=2)
    resultado_total = DecimalField('Resultado Total', places=2)
    qtd_vendas = DecimalField('Qtd Vendas', places=2)
    tkt_medio = DecimalField('Tkt Médio', places=2)
    serviços1 = DecimalField('Serviços 1', places=2)
    ...
    servicos_total = DecimalField('Serviços Total', places=2)
